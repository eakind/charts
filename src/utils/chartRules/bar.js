...
function BarRule (target, capsuleType, context) {
  ChartRule.call(this, target, capsuleType, context);
}
BarRule.prototype = Object.create(ChartRule.prototype);
/**
 *
 * @param {*} targetType
 * @param {是否是交换特征} flag
 */
BarRule.prototype.draggingTipsFlag = function ([targetType, flag, featureName]) {
  let that = this;
...
BarRule.prototype.allowNumFlag = function ({
  target,
  capsuleType,
  context,
  flag,
...
BarRule.prototype.sameFeatureFlag = function ({
  target,
  capsuleType,
  context,
  flag,
