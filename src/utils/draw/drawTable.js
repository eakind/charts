...
let drawTableObj = function drawTableProcess ({
  ...
  function setTableCellSetting () {
    if (canvasCss.tableSetting) {
      ...
      baseConfig.table.inner.width = inner.width;
      baseConfig.table.inner.color = inner.color;
      baseConfig.table.outter.width = outter.width;
      baseConfig.table.outter.color = outter.color;
      baseConfig.table.padding.top = padding.top;
      baseConfig.table.padding.bottom = padding.bottom;
      baseConfig.table.padding.left = padding.left;
      baseConfig.table.padding.right = padding.right;
      baseConfig.table.body.width = Number(cell.width);
    }
  }
  /**
     * 获取表头信息
